...
/**
 * Share-Buttons: Copy Link, WhatsApp, LinkedIn
 */
export default function ShareButtons({ url, title }) {
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      >
        {copied ? (
          <svg className="w-3.5 h-3.5" style={{ color: 'var(--accent-text)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
